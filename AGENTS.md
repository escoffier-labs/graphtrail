...
Build, then pipe newline-delimited JSON-RPC into the server over stdio. It speaks JSON-RPC 2.0 and exposes six read-only tools (`search`, `callers`, `callees`, `impact`, `context`, `stats`).
